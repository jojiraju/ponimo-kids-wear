...
export default function About() {
  ...
  return (
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      {/* Immersive Hero */}
      <section className="relative pt-32 md:pt-48 pb-20 md:pb-32 px-6 md:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
              ...
              >
                 ...
                 <h1 className="text-5xl md:text-[9rem] font-heading font-bold leading-[0.85] tracking-tighter">
                   Modern <br />
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
           ...
           <motion.div {...fadeInUp} className="space-y-8 md:space-y-10 order-1 lg:order-2 text-center lg:text-left">
              <h2 className="text-4xl md:text-7xl font-heading font-bold leading-tight">Our <br /><span className="italic text-primary">Philosophy</span></h2>
              <div className="space-y-4 md:space-y-6 text-base md:text-lg text-foreground/60 font-light leading-relaxed">
                 <p>
              ...
              <div className="pt-6 grid grid-cols-2 gap-8 md:gap-10">
                 <div className="space-y-2">
                    <p className="text-3xl md:text-4xl font-heading font-bold text-primary">2020</p>
      ...
      <section className="py-20 md:py-32 bg-white overflow-hidden">
        <div className="max-w-7xl auto px-6 md:px-12">
           <motion.div {...fadeInUp} className="text-center space-y-4 mb-16 md:mb-24">
              <span className="text-primary font-bold tracking-[0.4em] uppercase text-[10px]">The Making</span>
              <h2 className="text-4xl md:text-7xl font-heading font-bold">Artisanal <span className="italic text-primary">Excellence</span></h2>
           </motion.div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
              <motion.div {...fadeInUp} className="md:col-span-8 relative h-[400px] md:h-[500px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden group">
                 ...
                 <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white">
                    ...
                    <p className="text-xs md:text-sm font-light opacity-60">Sourced from historic European mills.</p>
                 </div>
              </motion.div>
              <motion.div {...fadeInUp} className="md:col-span-4 relative h-[400px] md:h-[500px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden group">
                 ...
                 <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white">
                    ...
                    <p className="text-xs md:text-sm font-light opacity-60">GOTS certified for ultimate softness.</p>
                 </div>
              </motion.div>
           </div>
        </div>
      ...
      {/* Mission Signature */}
      <section className="py-32 md:py-48 px-6 md:px-12 max-w-5xl mx-auto text-center relative">
         ...
         <motion.div {...fadeInUp} className="space-y-10 md:space-y-16 relative z-10">
            <h2 className="text-3xl md:text-6xl font-heading font-light leading-tight italic">
            ...
            <div className="space-y-4">
               <div className="h-[1px] w-24 md:w-32 bg-primary/20 mx-auto" />
               <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-foreground/40">The Ponimo Vision</p>
            </div>
         </motion.div>
      </section>
